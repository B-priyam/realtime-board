...
import CurserPresence from './CurserPresence'
import { colorToCss, connectionIdToColor, findIntersectingLayersWithRectangle, penPointsToPathLayer, pointerEventToCanvasPoint, resizeBounce } from '@/lib/utils'
...
const Canvas = ({ boardId }: CanvasProps) => {
  ...
  const onResizeHandlePointerDown = useCallback((
    ...
    history.pause()
    setCanvasState({mode:CanvasMode.Resizing,initialBounce,
      corner
    })
  },[history])
  ...
  }, [canvasState,continueDrawing,camera,resizeSelectedLayer,translateSelectedLayer,updateSelectionNet,startMultiSelection])
